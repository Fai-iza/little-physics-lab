 ...
 * @author ano
 */
public class Scene2_1Controller implements Initializable {
...
private  String URL="1edit11.wav";
private Boolean flag=true;
    
     @FXML
    public void goBack(ActionEvent event) throws IOException{
        
    Parent tableViewParent =  FXMLLoader.load (getClass().getResource("Scene_4.fxml"));
